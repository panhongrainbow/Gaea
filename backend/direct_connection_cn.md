...
- 数数库服务器回传的乱数 scramble为 []uint8{81, 64, 43, 85, 76, 90, 97, 91, 34, 53, 36, 85, 93, 86, 117, 105, 49, 87, 65, 125}，这是用十进位的方式来表示
...
接合 "服务器所提供的乱数" <接合> SHA1( SHA1( 密码 ) ) 的接合值
...
# 转成十进位为
# scramble 为 []uint8{128, 18, 212, 25, 163, 228, 214, 83, 203, 204, 27, 235, 147, 219, 179, 198, 14, 176, 254, 126} // 十进位 (代码产出的答案相同)
```
